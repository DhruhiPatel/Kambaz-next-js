    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                paragraph is preceded by the heading Heading Tags. The font of the 
                section headings are usually larger and bolder than the plain text and 
                their subsection headings. This document uses headings to introduce topics 
                such as HTML Documents, HTML Tags, Heading Tags, etc. HTML 
                heading tags can be used to format plain text so that it renders in a 
                browser as large headings. There are 6 heading tags for different sizes: h1, 
            ...
            <div id="wd-p-tag">
                ...
                This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.</p>
                <p id="wd-p-2">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favourite-recipe">
                    <li>Boil the rice and beans.</li>
                    <li>Chop veggies of your choice.</li>
                    <li>Smash avocado and add spices,salt and lemon</li>
                    <li>Serve eveything prepared in a bowl topped with cheese and some sauces.</li>
                </ol>
                ...
                <ul id="wd-your-books">
                    ...
                    <li>BhagwatGeeta</li>
                    <li>The bird with golden wings.</li>
                </ul>
            ...
            <div id="wd-images">
                ...
                <br />
                <img id="wd-teslabot" src="/images/Teslabot.webp" height="200px" alt="teslabot"/>
            </div>
            <div id="wd-forms">
                <h4>Form Elements</h4>
...
<option value="FANTASY">Fantasy</option>
                ...
                <h4>Anchor tag</h4>
                Please
                <a href="https://github.com/" id="wd-github">click here</a>
                to get dummy text<br/>
            </div>
