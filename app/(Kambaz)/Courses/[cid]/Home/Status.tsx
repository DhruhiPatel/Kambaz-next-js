import { MdDoNotDisturbAlt, MdOutlineAnalytics, MdOutlineNotificationsActive, MdOutlineHome } from "react-icons/md";
import { FaCheckCircle, FaBullhorn, FaStream } from "react-icons/fa";
...
export default function CourseStatus() {
    return (
     ...
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
      ...
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <MdOutlineNotificationsActive className="me-2 fs-5" /> View Course Notifications
      </Button>
