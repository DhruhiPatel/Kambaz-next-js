...
export default function AssignmentEditor() {
  ...
  const initial: Assignment = useMemo(() => {
    ...
    return {
      ...
      points: 100,
      available: toLocalISO(new Date()),
      due: toLocalISO(new Date()),
      until: toLocalISO(new Date()),
    };
    ...
    <Card className="p-4 m-4 shadow-sm">
      <Form>
        ...
        <Form.Group as={Row} className="mb-3 align-items-center">
          ...
          <Col sm={9}>
            <Form.Select defaultValue="ASSIGNMENTS" disabled={ro}>
        ...
        <Form.Group as={Row} className="mb-3 align-items-center">
          ...
          <Col sm={9}>
            <Form.Select defaultValue="Percentage" disabled={ro}>
          ...
          <Col sm={9}>
            <Card className="p-3">
              <Form.Group className="mb-3">
                ...
                <Form.Select defaultValue="Everyone" disabled={ro}>
